        ...
        <div class="row">
			  ...
			  <div class="">
				<div class="input-group">
			      ...
			      <input type="radio" name="sex" value="1" class="" id="txt_search_sex1" >男
			      <input type="radio" name="sex" value="0" class="" id="txt_search_sex2" >女
				</div>
			  </div>
			  <div class="">
				<div class="input-group">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td>
									<input type="radio" id="sex1" name="sex" value="1"   class="" aria-required="true" required/>男
									<input type="radio" id="sex2" name="sex" value="0"   class="" aria-required="true" required/>女
								</td>
							</tr>
							<tr>
								<td>学生年龄：</td>
